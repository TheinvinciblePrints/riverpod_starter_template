...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DefaultError);
}
...
class BadRequestError implements NetworkExceptions {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BadRequestError);
}
...
@override
String toString() {
  return 'NetworkExceptions.badRequestError()';
}
...
class ForbiddenError implements NetworkExceptions {
...
@override
String toString() {
  return 'NetworkExceptions.forbiddenError()';
}
